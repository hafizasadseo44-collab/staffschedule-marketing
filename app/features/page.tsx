...
const ALL_FEATURES = [
  // Scheduling
  { cat: "scheduling", icon: Calendar, grad: "from-indigo-500 to-indigo-700", glow: "rgba(99,102,241,0.18)", title: "Employee Scheduling", desc: "Drag-and-drop shift planning, color-coded role assignments, and instant publishing to every device.", href: "/employee-schedule-maker", image: "https://images.unsplash.com/photo-1552581234-26160f608093?q=80&w=600&auto=format&fit=crop", featured: true },
  { cat: "scheduling", icon: Sparkles, grad: "from-violet-500 to-violet-700", glow: "rgba(124,58,237,0.18)", title: "AI-Powered Scheduling", desc: "Auto-generate optimized schedules based on demand, availability, skills, and labor budget.", href: "/features/ai", image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=600&auto=format&fit=crop", featured: true },
  { cat: "scheduling", icon: Layers, grad: "from-purple-500 to-purple-700", glow: "rgba(168,85,247,0.18)", title: "Scheduling Templates", desc: "Save recurring patterns as reusable templates. Build next week's schedule in under sixty seconds.", href: "/employee-schedule-maker", image: "https://images.unsplash.com/photo-1611162617474-5b21e879e113?q=80&w=600&auto=format&fit=crop" },
  { cat: "scheduling", icon: Repeat, grad: "from-fuchsia-500 to-fuchsia-700", glow: "rgba(217,70,239,0.18)", title: "Shift Swaps", desc: "Employees swap shifts in the app with manager approval. No phone tag, no missed coverage.", href: "/features/shift-swaps", image: "https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=600&auto=format&fit=crop" },
  { cat: "scheduling", icon: Target, grad: "from-pink-500 to-pink-700", glow: "rgba(236,72,153,0.18)", title: "Open Shifts Marketplace", desc: "Post open shifts that qualified staff can claim instantly. Coverage gaps closed in minutes.", href: "/features/open-shifts", image: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=600&auto=format&fit=crop" },
  { cat: "scheduling", icon: Building2, grad: "from-rose-500 to-rose-700", glow: "rgba(244,63,94,0.18)", title: "Multi-Location Management", desc: "Manage every site from one dashboard. Move staff between locations with a single tap.", href: "/features/multi-location", image: "https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=600&auto=format&fit=crop" },

  // Time & Attendance
  { cat: "time", icon: Clock, grad: "from-purple-500 to-purple-700", glow: "rgba(168,85,247,0.18)", title: "GPS Time Clock", desc: "Mobile clock-in with GPS, geofencing, and photo verification. Eliminate buddy punching forever.", href: "/time-clock-software", image: "https://images.unsplash.com/photo-1584438784894-089d6a62b8fa?q=80&w=600&auto=format&fit=crop", featured: true },
  { cat: "time", icon: ClipboardCheck, grad: "from-violet-500 to-violet-700", glow: "rgba(124,58,237,0.18)", title: "Attendance Tracking", desc: "Real-time attendance dashboard. Flag late arrivals, no-shows, and early outs automatically.", href: "/features/attendance", image: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=600&auto=format&fit=crop" },
  { cat: "time", icon: Shield, grad: "from-indigo-500 to-indigo-700", glow: "rgba(99,102,241,0.18)", title: "Compliance Tracking", desc: "Built-in break, overtime, and labor law enforcement. Stay audit-ready in every jurisdiction.", href: "/features/compliance", image: "https://images.unsplash.com/photo-1589829085413-56de8ae18c73?q=80&w=600&auto=format&fit=crop" },

  // People Management
  { cat: "people", icon: UserCheck, grad: "from-fuchsia-500 to-fuchsia-700", glow: "rgba(217,70,239,0.18)", title: "Leave Management", desc: "Time-off requests, approvals, and accrual tracking in one workflow. No more spreadsheets.", href: "/features/leave-management", image: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=600&auto=format&fit=crop", featured: true },
  { cat: "people", icon: Activity, grad: "from-pink-500 to-pink-700", glow: "rgba(236,72,153,0.18)", title: "Employee Availability", desc: "Staff submit availability and time-off in-app. Schedules respect it automatically.", href: "/features/availability", image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?q=80&w=600&auto=format&fit=crop" },

  // Communication
  { cat: "comms", icon: MessageSquare, grad: "from-sky-500 to-sky-700", glow: "rgba(14,165,233,0.18)", title: "Team Messaging", desc: "Direct messages, group chats, and broadcast announcements. Built for shift-based work.", href: "/team-messaging", image: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?q=80&w=600&auto=format&fit=crop", featured: true },
  { cat: "comms", icon: Megaphone, grad: "from-cyan-500 to-cyan-700", glow: "rgba(6,182,212,0.18)", title: "Team Announcements", desc: "Send pinned, read-receipt-tracked updates to your whole team or specific groups.", href: "/features/announcements", image: "https://images.unsplash.com/photo-1588196749597-9ff075ee6b5b?q=80&w=600&auto=format&fit=crop" },
  { cat: "comms", icon: Bell, grad: "from-blue-500 to-blue-700", glow: "rgba(59,130,246,0.18)", title: "Real-Time Notifications", desc: "Push, SMS, and email alerts for schedule changes, shift offers, and approvals.", href: "/features/communication", image: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?q=80&w=600&auto=format&fit=crop" },

  // Insights & Payroll
  { cat: "insights", icon: BarChart3, grad: "from-emerald-500 to-emerald-700", glow: "rgba(16,185,129,0.18)", title: "Workforce Analytics", desc: "Labor cost dashboards, attendance trends, and overtime forecasts. Make data-driven decisions.", href: "/features/analytics", image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=600&auto=format&fit=crop", featured: true },
  { cat: "insights", icon: PieChart, grad: "from-teal-500 to-teal-700", glow: "rgba(20,184,166,0.18)", title: "Custom Reports", desc: "Export-ready reports for every metric you track. Schedule them, share them, automate them.", href: "/features/reporting", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=600&auto=format&fit=crop" },
  { cat: "insights", icon: CreditCard, grad: "from-green-500 to-green-700", glow: "rgba(34,197,94,0.18)", title: "Payroll Integration", desc: "Sync approved timesheets directly with your payroll provider. Zero manual entry.", href: "/features/payroll", image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=600&auto=format&fit=crop" },
];
