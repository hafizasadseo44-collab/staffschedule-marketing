    ...
    <section ref={containerRef} className="relative min-h-[100vh] flex flex-col justify-start pt-32 pb-20 overflow-hidden font-sans selection:bg-purple-200 selection:text-purple-900 bg-[#FAFAFA]">
      ...
      <div className="container mx-auto px-6 relative z-30 flex flex-col items-center flex-1">
        ...
        <motion.div style={{ y: textY }} className="flex flex-col items-center max-w-6xl mx-auto text-center mt-4 sm:mt-12 w-full">
          ...
          >
            Spend Less Time on <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] via-[#8b5cf6] to-[#ec4899]">Staff Scheduling</span> and More Time Growing Your Business
          </motion.h1>
        </motion.div>
        ...
        <motion.div style={{ y: textY }} className="flex flex-col items-center text-center w-full max-w-4xl mx-auto mt-4 z-10 relative">
          ...
          >
            StaffSchedule.io helps businesses manage staff scheduling, employee availability, leave requests, shift planning, and team communication from one workforce management platform. Stay connected with employees, manage multiple locations, and reduce scheduling confusion with real-time updates and smarter shift management.
          </motion.p>
