  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        {/* Expanded Card Overlay (Moved outside transformed container to prevent clipping) */}
        <AnimatePresence>
          {activeNodeId && (
            (() => {
                ...
                <>
                  ...
                  <motion.div 
                    ...
                    className={`
                      ...
                      top-1/2 sm:top-[20%] left-1/2 -translate-x-1/2 -translate-y-1/2 sm:translate-y-0
                      w-[90vw] sm:w-80 
